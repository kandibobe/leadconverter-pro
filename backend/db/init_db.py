    ...
    initial_quiz_data = schemas.QuizCreate(
        ...
        questions=[
            schemas.QuestionCreate(
                ...
                options=[
                    schemas.OptionCreate(
                        text="Косметический", price_impact=5000, order=1
                    ),
                    schemas.OptionCreate(
                        text="Капитальный (White box)", price_impact=15000, order=2
                    ),
                    schemas.OptionCreate(
                        text="Дизайнерский", price_impact=30000, order=3
                    ),
                ],
            ),
            schemas.QuestionCreate(
            ...
            schemas.QuestionCreate(
                ...
                options=[
                    schemas.OptionCreate(
                        text="Да, требуется снос и возведение стен",
                        price_impact=80000,
                        order=1,
                    ),
                    schemas.OptionCreate(
                        text="Нет, планировка остается прежней", price_impact=0, order=2
                    ),
                ],
            ),
        ],
