...
# ✅ Явный список origin'ов для dev (иначе CORS не пройдет при allow_credentials=True)
origins = os.getenv(
...
app.add_middleware(
    ...
    allow_credentials=True,           # можно оставить True — но тогда НУЖНЫ явные origins
    allow_methods=["*"],
    allow_headers=["*"],
)
