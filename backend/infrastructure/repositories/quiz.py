...
from app.domain.quiz import QuizCreate
from app.domain.quiz_event import QuizEventCreate
...
class CRUDQuiz:
    ...
    def create(self, db: Session, *, obj_in: QuizCreate, tenant_id: str) -> Quiz:
        ...
        from app.infrastructure.repositories.quiz_event import quiz_event
