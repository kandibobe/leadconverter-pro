...
from app.domain import quiz as quiz_schema
from app.infrastructure.repositories import quiz as quiz_repo
...
@router.get("/{quiz_id}", response_model=quiz_schema.Quiz)
def read_quiz(
    quiz_id: int,
    ...
    quiz = quiz_repo.get(db=db, id=quiz_id, tenant_id=tenant_id)
